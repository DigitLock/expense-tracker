...
const (
	CategoryService_ListCategories_FullMethodName = "/expense_tracker.v1.CategoryService/ListCategories"
	CategoryService_CreateCategory_FullMethodName = "/expense_tracker.v1.CategoryService/CreateCategory"
	CategoryService_UpdateCategory_FullMethodName = "/expense_tracker.v1.CategoryService/UpdateCategory"
	CategoryService_DeleteCategory_FullMethodName = "/expense_tracker.v1.CategoryService/DeleteCategory"
)
...
func (c *categoryServiceClient) DeleteCategory(ctx context.Context, in *DeleteCategoryRequest, opts ...grpc.CallOption) (*DeleteResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (UnimplementedCategoryServiceServer) DeleteCategory(context.Context, *DeleteCategoryRequest) (*DeleteResponse, error) {
...
var CategoryService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "expense_tracker.v1.CategoryService",
