...
-- Purpose: Use transaction.amount (native currency) instead of amount_base
--          (converted to RSD) for account balance calculation.
--
-- Rationale: Account balances should be in the account's own currency.
--            amount_base exists for cross-currency aggregate reports only.
-- ============================================================================
